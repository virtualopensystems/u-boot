 ...
 */
static void i2s_set_lr_framesize(struct exynos5_i2s *i2s_reg, unsigned int rfs)
{
 ...
 */
static void i2s_txctrl(struct exynos5_i2s *i2s_reg, int on)
{
 ...
 */
static void i2s_set_bitclk_framesize(struct exynos5_i2s *i2s_reg, unsigned bfs)
{
	unsigned int mod = readl(&i2s_reg->mod);
 ...
 */
int i2s_set_sysclk_dir(struct exynos5_i2s *i2s_reg, int dir)
{
	unsigned int mod = readl(&i2s_reg->mod);
 ...
 * @return		int value 0 for success, -1 in case of error
 */
int i2s_set_fmt(struct exynos5_i2s *i2s_reg, unsigned int fmt)
{
	unsigned int mod = readl(&i2s_reg->mod);
	unsigned int tmp = 0;
	unsigned int ret = 0;
 ...
 * @return		int value 0 for success, -1 in case of error
 */
int i2s_set_samplesize(struct exynos5_i2s *i2s_reg, unsigned int blc)
{
	unsigned int mod = readl(&i2s_reg->mod);
