...
struct max77686_para max77686_param[] = {/*{regnum, vol_addr, vol_bitpos,
	vol_bitmask, reg_enaddr, reg_enbitpos, reg_enbiton, reg_enbitoff,
	vol_min, vol_div}*/
	{PMIC_BUCK1, 0x11, 0x0, 0x3F, 0x10, 0x0, 0x3, 0x0, 750,	50000},
	{PMIC_BUCK2, 0x14, 0x0,	0xFF, 0x12, 0x4, 0x1, 0x0, 600, 12500},
	{PMIC_BUCK3, 0x1E, 0x0, 0xFF, 0x1C, 0x4, 0x1, 0x0, 600,	12500},
	{PMIC_BUCK4, 0x28, 0x0, 0xFF, 0x26, 0x4, 0x1, 0x0, 600,	12500},
	{PMIC_BUCK5, 0x31, 0x0, 0x3F, 0x30, 0x0, 0x3, 0x0, 750,	50000},
	{PMIC_BUCK6, 0x33, 0x0,	0x3F, 0x32, 0x0, 0x3, 0x0, 750,	50000},
	{PMIC_BUCK7, 0x35, 0x0,	0x3F, 0x34, 0x0, 0x3, 0x0, 750,	50000},
	{PMIC_BUCK8, 0x37, 0x0,	0x3F, 0x36, 0x0, 0x3, 0x0, 750,	50000},
	{PMIC_BUCK9, 0x39, 0x0,	0x3F, 0x38, 0x0, 0x3, 0x0, 750,	50000},
	{PMIC_LDO1,  0x40, 0x0,	0x3F, 0x40, 0x6, 0x3, 0x0, 800,	25000},
	{PMIC_LDO2,  0x41, 0x0,	0x3F, 0x41, 0x6, 0x1, 0x0, 800,	25000},
	{PMIC_LDO3,  0x42, 0x0, 0x3F, 0x42, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO4,  0x43, 0x0,	0x3F, 0x43, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO5,  0x44, 0x0,	0x3F, 0x44, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO6,  0x45, 0x0,	0x3F, 0x45, 0x6, 0x1, 0x0, 800,	25000},
	{PMIC_LDO7,  0x46, 0x0,	0x3F, 0x46, 0x6, 0x1, 0x0, 800,	25000},
	{PMIC_LDO8,  0x47, 0x0,	0x3F, 0x47, 0x6, 0x1, 0x0, 800,	25000},
	{PMIC_LDO9,  0x48, 0x0, 0x3F, 0x48, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO10, 0x49, 0x0,	0x3F, 0x49, 0x6, 0x1, 0x0, 800,	50000},
	{PMIC_LDO11, 0x4A, 0x0,	0x3F, 0x4A, 0x6, 0x1, 0x0, 800,	50000},
	{PMIC_LDO12, 0x4B, 0x0, 0x3F, 0x4B, 0x6, 0x1, 0x0, 800,	50000},
	{PMIC_LDO13, 0x4C, 0x0,	0x3F, 0x4C, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO14, 0x4D, 0x0,	0x3F, 0x4D, 0x6, 0x1, 0x0, 800,	50000},
	{PMIC_LDO15, 0x4E, 0x0,	0x3F, 0x4E, 0x6, 0x1, 0x0, 800,	25000},
	{PMIC_LDO16, 0x4F, 0x0,	0x3F, 0x4F, 0x6, 0x1, 0x0, 800,	50000},
	{PMIC_LDO17, 0x50, 0x0,	0x3F, 0x50, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO18, 0x51, 0x0,	0x3F, 0x51, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO19, 0x52, 0x0,	0x3F, 0x52, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO20, 0x53, 0x0, 0x3F, 0x53, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO21, 0x54, 0x0,	0x3F, 0x54, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO22, 0x55, 0x0, 0x3F, 0x55, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO23, 0x56, 0x0,	0x3F, 0x56, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO24, 0x57, 0x0,	0x3F, 0x57, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO25, 0x58, 0x0,	0x3F, 0x58, 0x6, 0x3, 0x0, 800,	50000},
	{PMIC_LDO26, 0x59, 0x0,	0x3F, 0x59, 0x6, 0x3, 0x0, 800,	50000},
};
